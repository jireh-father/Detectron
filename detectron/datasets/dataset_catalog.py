...
_DATASETS = {
    ...
    'table_fp_not_table_ig_train': {
        ...
        _ANN_FN:
            _DATA_DIR + '/table_fp_not_table_ig_train/annotation.json'
    },
    'table_fp_vague_table_ig_train': {
        _IM_DIR:
            _DATA_DIR + '/table_fp_vague_table_ig_train/images',
        _ANN_FN:
    ...
    'table_tp_ig_val': {
        ...
        _ANN_FN:
            _DATA_DIR + '/table_tp_ig_val/annotation.json'
    },
    'table_tp_nh_val': {
        _IM_DIR:
            _DATA_DIR + '/table_tp_nh_val/images',
        _ANN_FN:
    ...
    'table_fp_not_table_ig_val_02': {
        _IM_DIR:
            _DATA_DIR + '/table_fp_not_table_ig_val_02/images',
        _ANN_FN:
            _DATA_DIR + '/table_fp_not_table_ig_val_02/annotation.json'
    },
    'table_fp_vague_table_ig_val_02': {
        _IM_DIR:
